...
<<<<<<< HEAD:pulsar-broker/src/main/java/org/apache/pulsar/broker/admin/impl/SinkBase.java
    @PUT
...
=======
>>>>>>> upstream/master:pulsar-functions/worker/src/main/java/org/apache/pulsar/functions/worker/rest/api/v3/SinksApiV3Resource.java
    @DELETE
    @Path("/{tenant}/{namespace}/{sinkName}")
